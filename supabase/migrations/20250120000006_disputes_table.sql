...
COMMENT ON TABLE public.disputes IS 'Dispute resolution system for order conflicts';
COMMENT ON COLUMN public.disputes.order_id IS 'Reference to the disputed order';
COMMENT ON COLUMN public.disputes.reason IS 'Brief reason for the dispute';
...
COMMENT ON COLUMN public.disputes.resolution_notes IS 'Admin notes about the resolution';
COMMENT ON COLUMN public.disputes.resolved_by IS 'Admin who resolved the dispute';
